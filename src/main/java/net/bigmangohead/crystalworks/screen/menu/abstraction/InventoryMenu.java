...
public abstract class InventoryMenu extends AbstractContainerMenu implements ICWBlockEntityMenu {
    ...
    public <T extends AbstractContainerMenu> InventoryMenu(int pContainerId, Inventory inv, CWBlockEntity entity, ContainerData data, int inventorySlotCount, MenuType<T> menuType) {
        ...
        addPlayerHotbar(inv);
        addBlockEntityInventory(entity);
    ...
    public ItemStack quickMoveStack(Player playerIn, int pIndex) {
        Slot sourceSlot = getSlot(pIndex);
        ...
        if (pIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            if (!moveItemStackTo(sourceStack, TE_INVENTORY_FIRST_SLOT_INDEX, TE_INVENTORY_FIRST_SLOT_INDEX
                    + inventorySlotCount, false)) {
                return ItemStack.EMPTY;  // If container is full, return empty item
            }

        } else if (pIndex < TE_INVENTORY_FIRST_SLOT_INDEX + inventorySlotCount) {
    ...
    protected abstract void addBlockEntityInventory(BlockEntity entity);
    ...
    public TrackedObject<?> getTrackedValue(String key) {
        return this.blockEntity.getTrackedObject(key);
    }
}
